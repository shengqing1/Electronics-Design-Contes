...
#define SDA_OUT()   {                                                  \
                        ...
                        DL_GPIO_setPins(MPU6050_PORT, MPU6050_MPU6050_SDA_PIN);      \
                        DL_GPIO_enableOutput(MPU6050_PORT, MPU6050_MPU6050_SDA_PIN); \
                    }
//设置SDA输入模式
#define SDA_IN()    { DL_GPIO_initDigitalInput(MPU6050_MPU6050_SDA_IOMUX); }

//获取SDA引脚的电平变化
#define SDA_GET()   ( ( ( DL_GPIO_readPins(MPU6050_PORT,MPU6050_MPU6050_SDA_PIN) & MPU6050_MPU6050_SDA_PIN ) > 0 ) ? 1 : 0 )
//SDA与SCL输出
#define SDA(x)      ( (x) ? (DL_GPIO_setPins(MPU6050_PORT,MPU6050_MPU6050_SDA_PIN)) : (DL_GPIO_clearPins(MPU6050_PORT,MPU6050_MPU6050_SDA_PIN)) )
#define SCL(x)      ( (x) ? (DL_GPIO_setPins(MPU6050_PORT,MPU6050_MPU6050_SCL_PIN)) : (DL_GPIO_clearPins(MPU6050_PORT,MPU6050_MPU6050_SCL_PIN)) )
